...
CREATE TABLE CustomerAccount (
  ...
  CardNumber VARCHAR(30) MASKED WITH (FUNCTION ='partial(0,"XXXXXXXXXXXX",4)') NULL,
...
insert into sdev_users (user_id, email, firstname, lastname,
city, state, zip)
values (4,'tblack@umuc.edu','Terrel', 'Blackston','Baltimore',
'MD','21207');
...
insert into CustomerAccount (account_id, user_id,
CardType, ServiceCode, CardNumber, CAV_CCV2, Cardholdername, expiredate,
FullTrackData,PIN) values (3,3,'AMEX','48w5','444444444444',123,'Customer','05/03/2019','65234qwpH39302','1234E5');
